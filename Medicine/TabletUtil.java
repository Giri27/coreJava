...
class TabletUtil{
	...
	public static void main(String a[]){
		...
		tab.medicineId = medicineId;
		tab.medicineType = medicineType;
		tab.mfgDate = mfgDate;
		tab.expiryDate = expiryDate;
		tab.price = price;
		tab.curesDisease();
		System.out.println(tab.medicineId +", "+ tab.medicineType +", "+ tab.mfgDate +", "+ tab.expiryDate +", "+ tab.price );
	}
